...
const Select = <T extends object, M extends "single" | "multiple" = "single">({
  ...
  return <SelectPrimitive data-slot="control" className={cx(className)} {...props} />;
};
